    ...
    return (
        <div>
            ...
            <p className="text-fade">
                ...
                inquiries, or would like to discuss a potential collaboration, I
                would love to hear from you. Please feel free to reach out to me
                using the contact information provided below.
            </p>
            <h2 className="mt-8">
                <a
                    className="hover:text-accent underline"
                    href="mailto:contact@fatihdev.com"
                >
            ...
            <div className="mt-12 space-x-3">
                <a
                    href="https://www.linkedin.com/in/fatcisk/"
                ...
                <a
                    href="https://github.com/uzayapiu"
                    className="inline-block bg-accent bg-opacity-10 font-medium text-accent p-3 rounded-lg duration-200 hover:bg-accent hover:text-white"
                >
                    Github
                </a>
