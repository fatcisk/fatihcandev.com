  ...
  return (
    <>
      <div className="mobile-nav z-10 fixed left-0 top-0 w-full h-screen hidden flex-col justify-center items-center space-y-6 bg-white">
        ...
        <a href="/about" className="link text-fade text-5xl font-medium">
          About
        </a>
        <a href="/articles" className="link text-fade text-5xl font-medium">
          Blog
        </a>
        <a href="/contact" className="link text-fade text-5xl font-medium">
          Contact
        </a>
      </div>
      ...
      <div className="hidden md:block mb-20 mt-8 p-3 border-t border-b border-disabled">
        <div className="flex justify-around">
          ...
          <a href="/about" className="link text-fade hover:text-accent">
            About
          </a>
          <a href="/articles" className="link text-fade hover:text-accent">
            Blog
          </a>
          <a href="/contact" className="link text-fade hover:text-accent">
            Contact
          </a>
        </div>
      </div>
